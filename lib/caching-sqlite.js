...
function createCache(maxAge, options) {
    ...
    database.serialize(function() {
        database.run("CREATE TABLE IF NOT EXISTS cache (name TEXT, value TEXT, creationTime INTEGER)");
        database.run("CREATE INDEX IF NOT EXISTS cache__name_time ON cache (name, creationTime)");
    });
